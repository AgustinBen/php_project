...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="/app_ci4/public">Home</a></li>
            <!-- <li class="menu-item hidden"><a href="/app_ci4/public/Login">Login</a></li> -->
            <li class="menu-item hidden"><a href="#" id="openLoginModal">Login</a></li>
